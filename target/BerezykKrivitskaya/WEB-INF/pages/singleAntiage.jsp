...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <span class="red">&nbsp;Антивозрастная&nbsp;</span>
            </li>
        </ul>
...
<c:url var="addAction" value="/singleAntiage/add"/>
                    ...
                    <div class="single_left">
                        <div class="grid images_3_of_2">
                            <ul id="etalage">
                                <li>
                                    <a href="optionallink.html">
                                        <img class="etalage_thumb_image"
                                             src="../../resources/images/antiage/${antiage.name}1.jpg"
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/antiage/${antiage.name}2.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/antiage/${antiage.name}2.jpg"
                                         class="img-responsive" title=""/>
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/antiage/${antiage.name}3.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/antiage/${antiage.name}3.jpg"
                                         class="img-responsive"/>
