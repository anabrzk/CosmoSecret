...
<c:url var="addAction" value="/singleEyes/add"/>
                    ...
                    <div class="single_left">
                        <div class="grid images_3_of_2">
                            <ul id="etalage">
                                <li>
                                    <a href="optionallink.html">
                                        <img class="etalage_thumb_image"
                                             src="../../resources/images/eyes/${eyes.name}1.jpg"
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/eyes/${eyes.name}2.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/eyes/${eyes.name}2.jpg"
                                         class="img-responsive" title=""/>
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/eyes/${eyes.name}3.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/eyes/${eyes.name}3.jpg"
                                         class="img-responsive"/>
                        ...
                        <div class="desc1 span_3_of_2">
                            ...
                            <h style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12pt;">
                                Состав: ${eyes.consist}</h>
                            <br>
                            <h style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12pt;">
                                Материал подкладки: ${eyes.liningMaterial}</h>
                            <br>
                            <h style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12pt;">Страна производства: ${eyes.country}</h>
                            <br>
                            <br>
