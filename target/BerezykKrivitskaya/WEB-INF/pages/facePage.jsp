...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <a href="/singleFace/${face.id}"><span class="red">&nbsp;Для лица&nbsp;</span></a>
            </li>
        </ul>
        <div class="clearfix"></div>
    </div>
            ...
            <div class="mens-toolbar">
                <div class="sort">
                    <div class="sort-by">
                        ...
                        <c:url var="addAction" value="/order"/>

                        <form:form action="${addAction}" commandName="face">
            ...
            <div class="box1" >
                ...
                <div class="col_1_of_single1 span_1_of_single1">
                    <div class="view1 view-fifth1">
                        <div class="top_box">
                            <h3 class="m_1">${face.name}</h3>
                            <p class="m_2">${face.brand}</p>
                            <a href="/singleFace/${face.id}">
                                <div class="grid_img">
                                    <div class="css3"><img src="../../resources/images/face/${face.name}1.jpg" alt=""/></div>
                                    <div class="mask1">
                                        <div class="info"><a href="/singleFace/${face.id}">Быстрый просмотр</a></div>
                                    </div>
                                </div>
                                <div class="price">$ ${face.price}</div>
                                </a>
                        </div>
                    </div>
                    ...
                    <ul class="list2"  class="icon1 sub-icon1 profile_img">
                        <li>
                            <ul class="icon1 sub-icon1 profile_img" >
                                <li><a class="active-icon c1" href="/singleFace/${face.id}">Добавить в корзину</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
...
<div class="rsidebar span_1_of_left">
    ...
    <c:url var="inputAction" value="/find"/>
    <form:form action="${inputAction}" commandName="face">
    <section class="sky-form">
        ...
        <div class="row row1 scroll-pane">
            <div class="col col-4">
                ...
                <c:forEach items="${listFace}" var="face">
                <label class="checkbox"><input type="radio" name="brand" value="${face.brand}"><i></i>${face.brand}</label>
                </c:forEach>
            </div>
    ...
    <c:url var="inputAction" value="/findPrice"/>
    <form:form action="${inputAction}" commandName="face">
    <section class="sky-form">
        <h4>Цена</h4>
        <div class="row row1 scroll-pane">
