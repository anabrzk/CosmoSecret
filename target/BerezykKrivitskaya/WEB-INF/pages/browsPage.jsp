...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <a href="<c:url value="/browsPage"/>"><span class="red">&nbsp;Брови&nbsp;</span></a>
            </li>
        </ul>
        <div class="clearfix"></div>
    </div>
    ...
    <div class="ft-ball">
        <div class="cont span_2_of_3">
            <div class="mens-toolbar">
                <div class="sort">
                    <div class="sort-by">
                        ...
                        <c:url var="addAction" value="/orderBrows"/>

                        <form:form action="${addAction}" commandName="brows">
            ...
            <div style=" max-height:750px; overflow:auto">
                ...
                <c:if test="${!empty listBrows}">
                <c:forEach items="${listBrows}" var="brows">
                <%
                    if (i % 3 == 1) {
                %>
                <div class="box1" >
                    ...
                    <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <h3 class="m_1">${brows.name}</h3>
                                <p class="m_2">${brows.brand}</p>
                                <a href="/singleBrows/${brows.id}">
                                    <div class="grid_img">
                                        <div class="css3"><img src="../../resources/images/brows/${brows.name}1.jpg" alt=""/></div>
                                        <div class="mask1">
                                            <div class="info"><a href="/singleBrows/${brows.id}">Быстрый просмотр</a></div>
                                        </div>
                                    </div>
                                    <div class="price">$ ${brows.price}</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <ul class="list2"  class="icon1 sub-icon1 profile_img">
                            <li>
                                <ul class="icon1 sub-icon1 profile_img" >
                                    <li><a class="active-icon c1" href="/singleBrows/${brows.id}">Добавить в корзину</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
<div class="rsidebar span_1_of_left">
    ...
    <c:url var="inputAction" value="/findBrows"/>
    <form:form action="${inputAction}" commandName="brows">
        <section class="sky-form">
            ...
            <div class="row row1 scroll-pane">
                <div class="col col-4">
                    ...
                    <c:forEach items="${listBrows}" var="brows">
                        <label class="checkbox"><input type="radio" name="brand" value="${brows.brand}"><i></i>${brows.brand}</label>
                    </c:forEach>
                </div>
    ...
    <c:url var="inputAction" value="/findPriceBrows"/>
    <form:form action="${inputAction}" commandName="brows">
        <section class="sky-form">
            <h4>Цена</h4>
            <div class="row row1 scroll-pane">
