...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <a href="/singleCare/${care.id}"><span class="red">&nbsp;Увлажнение и питание&nbsp;</span></a>
            </li>
        </ul>
        <div class="clearfix"></div>
    </div>
            ...
            <div class="mens-toolbar">
                <div class="sort">
                    <div class="sort-by">
                        ...
                        <c:url var="addAction" value="/orderCare"/>

                        <form:form action="${addAction}" commandName="care">
                ...
                <div class="box1" >
                    ...
                    <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <h3 class="m_1">${care.name}</h3>
                                <p class="m_2">${care.brand}</p>
                                <a href="/singleCare/${care.id}">
                                    <div class="grid_img">
                                        <div class="css3"><img src="../../resources/images/care/${care.name}1.jpg" alt=""/></div>
                                        <div class="mask1">
                                            <div class="info"><a href="/singleCare/${care.id}">Быстрый просмотр</a></div>
                                        </div>
                                    </div>
                                    <div class="price">$ ${care.price}</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <ul class="list2"  class="icon1 sub-icon1 profile_img">
                            <li>
                                <ul class="icon1 sub-icon1 profile_img" >
                                    <li><a class="active-icon c1" href="/singleCare/${care.id}">Добавить в корзину</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
<div class="rsidebar span_1_of_left">
    ...
    <c:url var="inputAction" value="/findCare"/>
    <form:form action="${inputAction}" commandName="care">
        <section class="sky-form">
            ...
            <div class="row row1 scroll-pane">
                <div class="col col-4">
                    ...
                    <c:forEach items="${listCare}" var="care">
                        <label class="checkbox"><input type="radio" name="brand" value="${care.brand}"><i></i>${care.brand}</label>
                    </c:forEach>
                </div>
    ...
    <c:url var="inputAction" value="/findPriceCare"/>
    <form:form action="${inputAction}" commandName="care">
        <section class="sky-form">
            <h4>Цена</h4>
            <div class="row row1 scroll-pane">
