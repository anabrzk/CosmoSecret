...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <span class="red">&nbsp;Брови&nbsp;</span>
            </li>
        </ul>
        <div class="clearfix"></div>
    </div>
</div>
<c:url var="addAction" value="/singleBrows/add"/>
                    ...
                    <div class="single_left">
                        <div class="grid images_3_of_2">
                            <ul id="etalage">
                                <li>
                                    <a href="optionallink.html">
                                        <img class="etalage_thumb_image"
                                             src="../../resources/images/brows/${brows.name}1.jpg"
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/brows/${brows.name}2.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/brows/${brows.name}2.jpg"
                                         class="img-responsive" title=""/>
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/brows/${brows.name}3.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/brows/${brows.name}3.jpg"
                                         class="img-responsive"/>
