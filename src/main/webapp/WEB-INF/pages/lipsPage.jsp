...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <a href="/singleLips/${lips.id}"><span class="red">&nbsp;Губы&nbsp;</span></a>
            </li>
        </ul>
    ...
    <div class="ft-ball">
        <div class="cont span_2_of_3">
            <div class="mens-toolbar">
                <div class="sort">
                    <div class="sort-by">
                        ...
                        <c:url var="addAction" value="/orderLips"/>

                        <form:form action="${addAction}" commandName="lips">
            ...
            <div style=" max-height:750px; overflow:auto">
                ...
                <c:if test="${!empty listLips}">
                <c:forEach items="${listLips}" var="lips">
                <%
                    if (i % 3 == 1) {
                %>
                <div class="box1" >
                    ...
                    <div class="col_1_of_single1 span_1_of_single1">
                        <div class="view1 view-fifth1">
                            <div class="top_box">
                                <h3 class="m_1">${lips.name}</h3>
                                <p class="m_2">${lips.brand}</p>
                                <a href="/singleLips/${lips.id}">
                                    <div class="grid_img">
                                        <div class="css3"><img src="../../resources/images/lips/${lips.name}1.jpg" alt=""/></div>
                                        <div class="mask1">
                                            <div class="info"><a href="/singleLips/${lips.id}">Быстрый просмотр</a></div>
                                        </div>
                                    </div>
                                    <div class="price">$ ${lips.price}</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <ul class="list2"  class="icon1 sub-icon1 profile_img">
                            <li>
                                <ul class="icon1 sub-icon1 profile_img" >
                                    <li><a class="active-icon c1" href="/singleLips/${lips.id}">Добавить в корзину</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
<div class="rsidebar span_1_of_left">
    ...
    <c:url var="inputAction" value="/findLips"/>
    <form:form action="${inputAction}" commandName="lips">
        <section class="sky-form">
            ...
            <div class="row row1 scroll-pane">
                <div class="col col-4">
                    ...
                    <c:forEach items="${listLips}" var="lips">
                        <label class="checkbox"><input type="radio" name="brand" value="${lips.brand}"><i></i>${lips.brand}</label>
                    </c:forEach>
                </div>
    ...
    <c:url var="inputAction" value="/findPriceLips"/>
    <form:form action="${inputAction}" commandName="lips">
        <section class="sky-form">
            <h4>Цена</h4>
            <div class="row row1 scroll-pane">
