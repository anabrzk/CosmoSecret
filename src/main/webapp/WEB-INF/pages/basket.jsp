            ...
            <table border="1">
                ...
                <c:forEach items="${baskView}" var="bask">
                    ...
                    <tr>
                        ...
                        <td width="90" align="center"><a href="<c:url value='/edit/${bask.id}'/>">Купить</a></td>
                        <td width="90" align="center"><a href="<c:url value='/remove/${bask.id}'/>">Удалить</a></td>
                    </tr>
                </c:forEach>
...
<div class="footer">
    <div class="up-arrow">
        <a class="scroll" href="#home"><img src="resource/images/up.png" alt=""/></a>
    </div>
    <div class="container">
