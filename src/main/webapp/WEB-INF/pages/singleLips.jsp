...
<div class="container">
    <div class="dreamcrub">
        <ul class="breadcrumbs">
            ...
            <li>
                <span class="red">&nbsp;Губы&nbsp;</span>
            </li>
        </ul>
        <div class="clearfix"></div>
    </div>
</div>
<c:url var="addAction" value="/singleLips/add"/>
                    ...
                    <div class="single_left">
                        <div class="grid images_3_of_2">
                            <ul id="etalage">
                                <li>
                                    <a href="optionallink.html">
                                        <img class="etalage_thumb_image"
                                             src="../../resources/images/lips/${lips.name}1.jpg"
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/lips/${lips.name}2.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/lips/${lips.name}2.jpg"
                                         class="img-responsive" title=""/>
                                ...
                                <li>
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/lips/${lips.name}3.jpg"
                                         class="img-responsive"/>
                                    <img class="etalage_source_image"
                                         src="../../resources/images/lips/${lips.name}3.jpg"
                                         class="img-responsive"/>
                        ...
                        <div class="desc1 span_3_of_2">
                            ...
                            <h style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12pt;">
                                Состав: ${lips.consist}</h>
                            <br>
                            <h style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12pt;">Страна производства: ${lips.country}</h>
                            <br>
                            <br>
                ...
                <div class="col-md-3 span_1_of_right">
                    <div class="w_nav1">
                        ...
                        <ul>
                            ...
                            <li><a href="<c:url value="/cleanPage"/>">Oчищение</a></li>
