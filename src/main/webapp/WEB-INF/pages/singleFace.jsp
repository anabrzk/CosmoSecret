...
<c:url var="addAction" value="/singleFace/add"/>
                ...
                <div class="single_left">
                    <div class="grid images_3_of_2">
                        <ul id="etalage">
                            <li>
                                <a href="optionallink.html">
                                    <img class="etalage_thumb_image"
                                         src="../../resources/images/face/${face.name}1.jpg"
                            ...
                            <li>
                                <img class="etalage_thumb_image"
                                     src="../../resources/images/face/${face.name}2.jpg"
                                     class="img-responsive"/>
                                <img class="etalage_source_image"
                                     src="../../resources/images/face/${face.name}2.jpg"
                                     class="img-responsive" title=""/>
                            ...
                            <li>
                                <img class="etalage_thumb_image"
                                     src="../../resources/images/face/${face.name}3.jpg"
                                     class="img-responsive"/>
                                <img class="etalage_source_image"
                                     src="../../resources/images/face/${face.name}3.jpg"
                                     class="img-responsive"/>
